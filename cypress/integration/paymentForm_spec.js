describe("Payment Form", () => {
  ...
  describe("Form", () => {
    ...
    it("should have the 2 sub legends inside of fieldsets", () => {
      cy.get("fieldset legend")
        .should("have.length", 2)
        .and((legends) => {
          expect(legends[0]).to.contain.text("Contact Information");
          expect(legends[1]).to.contain.text("Payment Information");
        });
    });
